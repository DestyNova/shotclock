...
return{stopPropagation:a,preventDefault:b}});var _user$project$Main$formatShotTime=function(n){return A2(_elm_lang$core$Basics_ops["++"],_elm_lang$core$Basics$toString(n/10|0),A2(_elm_lang$core$Basics_ops["++"],".",_elm_lang$core$Basics$toString(A2(_elm_lang$core$Basics_ops["%"],n,10))))};var _user$project$Main$formatGameTime=function(n){return A2(_elm_lang$core$Basics_ops["++"],_elm_lang$core$Basics$toString(n/600|0),A2(_elm_lang$core$Basics_ops["++"],":",A3(_elm_lang$core$String$padLeft,2,_elm_lang$core$Native_Utils.chr("0"),_elm_lang$core$Basics$toString(A2(_elm_lang$core$Basics_ops["%"],n,600)/10|0))))};var _user$project$Main$showShotTimer=function(model){var n=model.turnTime;var c=_elm_lang$core$Native_Utils.cmp(n,50)<0?"red":"green";return A2(_elm_lang$html$Html$div,{ctor:"::",_0:_elm_lang$html$Html_Attributes$style({ctor:"::",_0:{ctor:"_Tuple2",_0:"color",_1:c},_1:{ctor:"[]"}}),_1:{ctor:"[]"}},{ctor:"::",_0:_elm_lang$html$Html$text(_user$project$Main$formatShotTime(n)),_1:{ctor:"[]"}})};var _user$project$Main$showGameTimer=function(model){var n=model.gameTime;var c=_elm_lang$core$Native_Utils.cmp(n,3e3)<0?"orange":"green";return A2(_elm_lang$html$Html$div,{ctor:"::",_0:_elm_lang$html$Html_Attributes$style({ctor:"::",_0:{ctor:"_Tuple2",_0:"color",_1:c},_1:{ctor:"[]"}}),_1:{ctor:"[]"}},{ctor:"::",_0:_elm_lang$html$Html$text(_user$project$Main$formatGameTime(n)),_1:{ctor:"[]"}})};var _user$project$Main$showCounter=function(model){return A2(_elm_lang$html$Html$div,{ctor:"[]"},{ctor:"::",_0:_user$project$Main$showGameTimer(model),_1:{ctor:"::",_0:_user$project$Main$showShotTimer(model),_1:{ctor:"[]"}}})};var _user$project$Main$view=function(model){return _user$project$Main$showCounter(model)};var _user$project$Main$update=F2(function(msg,model){var _p0=msg;var gameTime=model.gameTime-1;var turnTime=model.turnTime-1;var playing=model.playing&&_elm_lang$core$Native_Utils.cmp(turnTime,0)>0;var newModel=model.playing?_elm_lang$core$Native_Utils.update(model,{gameTime:gameTime,turnTime:turnTime,playing:playing}):model;return A2(_elm_lang$core$Platform_Cmd_ops["!"],newModel,{ctor:"[]"})});var _user$project$Main$init=A2(_elm_lang$core$Platform_Cmd_ops["!"],{gameTime:6e3,turnTime:150,playing:true},{ctor:"[]"});var _user$project$Main$Model=F3(function(a,b,c){return{gameTime:a,turnTime:b,playing:c}});var _user$project$Main$Tick=function(a){return{ctor:"Tick",_0:a}};var _user$project$Main$subscriptions=function(model){return model.playing?A2(_elm_lang$core$Time$every,.1*_elm_lang$core$Time$second,_user$project$Main$Tick):_elm_lang$core$Platform_Sub$none};var _user$project$Main$main=_elm_lang$html$Html$program({init:_user$project$Main$init,view:_user$project$Main$view,update:_user$project$Main$update,subscriptions:_user$project$Main$subscriptions})();var Elm={};Elm["Main"]=Elm["Main"]||{};if(typeof _user$project$Main$main!=="undefined"){_user$project$Main$main(Elm["Main"],"Main",undefined)}if(typeof define==="function"&&define["amd"]){define([],function(){return Elm});return}if(typeof module==="object"){module["exports"]=Elm;return}var globalElm=this["Elm"];if(typeof globalElm==="undefined"){this["Elm"]=Elm;return}for(var publicModule in Elm){if(publicModule in globalElm){throw new Error("There are two Elm modules called `"+publicModule+"` on this page! Rename one of them.")}globalElm[publicModule]=Elm[publicModule]}}).call(this);
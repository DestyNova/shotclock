...
var _user$project$Main$formatShotTime = function (n) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		_elm_lang$core$Basics$toString((n / 10) | 0),
		A2(
			_elm_lang$core$Basics_ops['++'],
			'.',
			_elm_lang$core$Basics$toString(
				A2(_elm_lang$core$Basics_ops['%'], n, 10))));
};
var _user$project$Main$formatGameTime = function (n) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		_elm_lang$core$Basics$toString((n / 600) | 0),
		A2(
			_elm_lang$core$Basics_ops['++'],
			':',
			A3(
				...
				_elm_lang$core$Native_Utils.chr('0'),
				_elm_lang$core$Basics$toString(
					(A2(_elm_lang$core$Basics_ops['%'], n, 600) / 10) | 0))));
};
var _user$project$Main$showShotTimer = function (model) {
	var n = model.turnTime;
...
var _user$project$Main$showGameTimer = function (model) {
	var n = model.gameTime;
...
var _user$project$Main$showCounter = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _user$project$Main$showGameTimer(model),
			_1: {
				ctor: '::',
				_0: _user$project$Main$showShotTimer(model),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Main$getCountdownAudio = function (n) {
				...
				var newModel = function () {
					...
					switch (_p2.ctor) {
						...
						case 'Busy':
							return _elm_lang$core$Native_Utils.update(
								model,
								{gameTime: gameTime, mode: mode});
						default:
							return _elm_lang$core$Native_Utils.update(
								model,
								{gameTime: gameTime, turnTime: turnTime, mode: mode});
					}
				}();
				return A2(_elm_lang$core$Platform_Cmd_ops['!'], newModel, commands);
			case 'StartGame':
				var newModel = _user$project$Main$initModel;
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						newModel,
			...
			_rundis$elm_bootstrap$Bootstrap_Button$button,
			{
				...
				_1: {
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _rundis$elm_bootstrap$Bootstrap_Button$onClick(_user$project$Main$StartGame),
							_1: {ctor: '[]'}
						}
					}
				}
			...
			_rundis$elm_bootstrap$Bootstrap_Button$button,
			{
				...
				_1: {
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _rundis$elm_bootstrap$Bootstrap_Button$onClick(_user$project$Main$EndGame),
							_1: {ctor: '[]'}
						}
					}
				}
...
var _user$project$Main$subscriptions = function (model) {
	return (!_elm_lang$core$Native_Utils.eq(model.mode, _user$project$Main$Stopped)) ? A2(_elm_lang$core$Time$every, 0.1 * _elm_lang$core$Time$second, _user$project$Main$Tick) : _elm_lang$core$Platform_Sub$none;
};
